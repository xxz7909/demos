#ifndef SRC_UTILS_sm2_H
#define SRC_UTILS_sm2_H
...
static unsigned char sm2Sbox[16*16]=
...
static unsigned char sm2iSbox[16*16]=
{
...
static unsigned char sm2Rcon[11*4]=
{
    0x00, 0x00, 0x00, 0x00,
        0x01, 0x00, 0x00, 0x00,
        0x02, 0x00, 0x00, 0x00,
...
class sm2 // Advanced Encryption Standard
{
public:
    ~sm2();
    sm2();
    sm2(int keySize, unsigned char* keyBytes);
...
private:
    int Nb; // block size in 32-bit words. Always 4 for sm2. (128 bits).
