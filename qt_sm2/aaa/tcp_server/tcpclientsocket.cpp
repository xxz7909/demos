...
{ 
    ...
    if((0 == fileBytes)&&(this->bytesAvailable()> sizeof(qint64)))
    {
        ...
        qDebug()<< "this_>byte"<<this->bytesAvailable();
        ...
        case ISCMD:
            ...
            case ISFILE:
                ...
                qDebug()<<"this->byte"<<this->bytesAvailable();
                qDebug()<<"file-size"<<fileBytes - sizeReceived;
                ...
                if(sizeReceived == fileBytes)
                {
                    ...
                    {
                        emit updatescree(filename_recived);
                        recv_reset();
                        inBlock.resize(0);
                        return;
                    }
                    ...
                    sm2Tools *sm2=new sm2Tools;
                    sm2->FileDecryptor(filename_recived,filename_jiemi);
