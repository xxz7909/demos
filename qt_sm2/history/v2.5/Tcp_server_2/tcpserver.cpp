    ...
    ui(new Ui::Tcpserver)
{
    ...
    connect(serverNew,&Server::updatescreen,this,&Tcpserver::soltupdatescreen);
}
...
void Tcpserver::on_pushButton_getscreen_clicked()
{
    QString _str="getscreen";
    QString strtemp;
    strtemp=ui->listView->selectionModel()->currentIndex().data().toString();
    int k3=strtemp.indexOf(':');
    QString peer=strtemp.mid(k3+1);
...
void Tcpserver::soltupdatescreen(QString str)
{
    ui->label_pic->setScaledContents(true);
    ui->label_pic->resize(ui->widget_2->size());
    ui->label_pic->setPixmap(QPixmap(str));
}
