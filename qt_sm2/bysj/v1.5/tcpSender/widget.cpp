    ...
    ui(new Ui::Widget)
{
    ...
    tcpClient = new QTcpSocket(this);
        ...
        //connect(tcpClient,SIGNAL(connected()),this,SLOT(sendusername()));
...
//    QString username2="BASEINFO:"+ui->LineEdit_username->text()+':'+info.addresses().first().toString();
...
void Widget::getinfo() //获取主机信息，进程信息模块信息存入文件中并加密
{
    QString localHostName = QHostInfo::localHostName();
    QHostInfo info = QHostInfo::fromName(localHostName);
    username=ui->LineEdit_username->text();
    QString username2="BASEINFO:"+username+':'+info.addresses().first().toString();
    ...
    QString filename_mingwen=tr("/home/wang/info_mingwen_%1.txt").arg(username);
    QString filename_miwen=tr("/home/wang/info_miwen_%1.txt").arg(username);
    fileName = filename_miwen;
