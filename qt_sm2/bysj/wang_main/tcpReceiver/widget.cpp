    ...
    ui(new Ui::Widget)
{
    ...
    //connect(ui->toolBox,SIGNAL(currentChanged(int)),this,SLOT(tabWidget_selected(QString)));
}
...
void Widget::tabWidget_selected( )
{
    ...
    QFile f("/home/wang/BYSJ/wang_main/build-tcpReceiver-Desktop_Qt_5_9_0_GCC_64bit-Debug/info.txt");
    ...
    for (int i=0 ;i<41;i++)
    {in.readLine();}//前往第54行，准备读取version文件
    QString g = in.readLine();//55
