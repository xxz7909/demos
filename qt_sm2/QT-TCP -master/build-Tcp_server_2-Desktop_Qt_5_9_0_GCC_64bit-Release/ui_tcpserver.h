...
public:
    ...
    QWidget *widget_2;
    QLabel *label_pic;
    QPushButton *pushButton_getscreen;
    ...
    void setupUi(QWidget *Tcpserver)
    {
        ...
        widget_2 = new QWidget(tab_7);
        widget_2->setObjectName(QStringLiteral("widget_2"));
        widget_2->setGeometry(QRect(10, 40, 711, 451));
        label_pic = new QLabel(widget_2);
        label_pic->setObjectName(QStringLiteral("label_pic"));
        label_pic->setGeometry(QRect(9, 9, 67, 17));
        pushButton_getscreen = new QPushButton(tab_7);
        pushButton_getscreen->setObjectName(QStringLiteral("pushButton_getscreen"));
        pushButton_getscreen->setGeometry(QRect(640, 10, 89, 25));
    ...
    void retranslateUi(QWidget *Tcpserver)
    {
        ...
        label_pic->setText(QApplication::translate("Tcpserver", "TextLabel", Q_NULLPTR));
        pushButton_getscreen->setText(QApplication::translate("Tcpserver", "\350\216\267\345\217\226\346\210\252\345\233\276", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_7), QApplication::translate("Tcpserver", "\350\216\267\345\217\226\345\261\217\345\271\225\346\210\252\345\233\276", Q_NULLPTR));
    } // retranslateUi
