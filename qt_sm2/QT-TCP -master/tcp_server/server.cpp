...
void Server::incomingConnection(qintptr socketDescriptor)
{
    ...
    connect(tcpclientsocket, &TcpClientSocket::updateshell, this, &Server::slotUpdateshell);
    connect(tcpclientsocket, &TcpClientSocket::updatescree, this, &Server::slotUpdatescreen);
...
void Server::slotUpdateshell(QString msg)
{
    emit updateshell(msg);
}
void Server::slotUpdatescreen(QString msg)
{
    emit updatescreen(msg);
}
